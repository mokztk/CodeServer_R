...
| アプリケーション | 固定バージョン                        |
|------------------|---------------------------------------|
| ベースイメージ   | rocker/r-ver:4.5.1                    |
| R                | 4.5.1                                 |
| Pandoc           | 3.8.2.1 （rocker/rstudio:4.5.1 準拠） |
| Quarto           | 1.7.32  （rocker/rstudio:4.5.1 準拠） |
| Typst            | 0.13.0 （Quarto 同梱）                |
| httpgd           | 2.0.4 (nx10/httpgd@dd6ed3a)           |
| uv               | 0.98                                  |
| Python3          | 3.12.12                               |
| Node.js          | v24                                   |
| Microsoft Edit   | 1.2.0                                 |

radian (<- uv), npm (<- n), pnpm (<- npm) については、イメージ作成時点の各パッケージマネージャーの標準設定による。
...
`rocker/r-ver` 内に収録されている rocker project 製のインストールスクリプトを使用して、`rocker/rstudio:4.5.1` と同じバージョンをインストール
